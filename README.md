# Contributing to Telegrafwizardsplunk
...
Telegrafwizardsplunk uses [prettier](https://github.com/prettier/prettier) to ensure consistent code formatting. It is recommended
